    ...
    public static function get_providers(){
        return [
            ...
            [
                ...
                'name' => 'TrustPilot',
                'heading' => __( 'Page URL', 'sb-customizer' ),
                'placeholder' => __( 'https://trustpilot.com/review/...', 'sb-customizer' ),
                'onlyDetails' => true
            ],
            [
                'type' => 'wordpress.org',
                'name' => 'WordPress.org',
                'heading' => __( 'Page URL', 'sb-customizer' ),
                'placeholder' => __( 'https://wordpress.org/...', 'sb-customizer' ),
                'onlyDetails' => true
            ]
        ];
    }
    ...
    */
    ...
    public static function get_plugin_notices(){
        ...
        if ( $should_show_notice ) {
            ...
            if( $noAPIProviderxists ){
                array_push( $notices, [
                    'type' => 'error',
                    'heading' => __( 'You have reached the number of allowed sources.', 'sb-reviews' ),
                    'description' => __('Due to API limitations your feeds will not show new reviews because you have reached the number of allowed sources.', 'sb-reviews'),
                ] );
            }
        }
    ...
    public static function upsell_modal_content()
    {
        ...
        return [
            ...
            'trustpilotProvider' => [
                'heading' => __('Upgrade to Pro to display TrustPilot reviews', 'sb-reviews'),
                'description' => __('Upgrade to our "Plus" tier to display reviews from the well known business review site.', 'sb-reviews'),
                ...
                'buttons' => [
                    ...
                    'demo' => 'https://smashballoon.com/reviews-feed/demo/?utm_campaign=reviews-free&utm_source=customizer&utm_medium=trustpilot-modal&utm_content=ViewDemo'
                ],
                'includeContent' => true
            ],
            'tripadvisorProvider' => [
            ...
            'wordpress.orgProvider' => [
                'heading' => __('Upgrade to Pro to display WordPress.org reviews', 'sb-reviews'),
                'description' => __('Upgrade to our "Elite" tier to display reviews for plugins and themes.', 'sb-reviews'),
                ...
                'buttons' => [
                    ...
                    'demo' => 'https://smashballoon.com/reviews-feed/demo/?utm_campaign=reviews-free&utm_source=customizer&utm_medium=wordpressorg-modal&utm_content=ViewDemo'
                ],
                'includeContent' => true
            ],
            'carouselModal' => [
            ...
            'reviewsMediaModal' => [
                'heading' => __('Upgrade to Pro to add images', 'sb-reviews'),
                'description' => __('Display images from Yelp and Tripadvisor reviews.', 'sb-reviews'),
            ...
            'filtersModal' => [
                ...
                'description' => __('Display the exact types of reviews you want customers to see.', 'sb-reviews'),
