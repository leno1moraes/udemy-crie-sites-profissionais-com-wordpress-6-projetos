...
/*-----------------------------------------------------------------------------------------------------------------------*/
    ...
    /**
     * Switch option for inner page sticky sidebar
     *
     * @since 1.0.0
     */
    $wp_customize->add_setting(
    ...
    /**
     * Switch option for front page sticky sidebar
     *
     * @since 1.0.0
     */
    $wp_customize->add_setting(
        'news_portal_front_sidebar_sticky_option',
        array(
            'default' => 'show',
            'sanitize_callback' => 'news_portal_sanitize_switch_option',
        )
    ...
    $wp_customize->add_control( new News_Portal_Customize_Switch_Control(
        $wp_customize,
            ...
            array(
                'type'      => 'switch',
                'label'     => esc_html__( 'Frontpage Sticky', 'news-portal' ),
                'description'   => esc_html__( 'Enable/Disable sticky sidebar for frontpage sidebar', 'news-portal' ),
                'section'   => 'news_portal_sidebar_sticky_section',
                'choices'   => array(
                    'show'  => esc_html__( 'Enable', 'news-portal' ),
                    'hide'  => esc_html__( 'Disable', 'news-portal' )
